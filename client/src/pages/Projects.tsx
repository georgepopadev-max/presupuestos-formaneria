  ...
  const proyectos: Proyecto[] = [
    {
      ...
      clienteId: 'c1',
      cliente: { id: 'c1', nombre: 'María García', cif: '12345678A', direccion: 'Calle Mayor 5', telefono: '600123456', email: 'maria@email.es', createdAt: new Date() },
      presupuestoIds: ['p1'],
      facturaIds: [],
      estado: 'en_progreso',
    ...
    },
    {
      ...
      clienteId: 'c2',
      cliente: { id: 'c2', nombre: 'Comunidad Madrid 15', cif: 'H12345678', direccion: 'Avda Principal 15', telefono: '912345678', email: 'info@comunidad15.es', createdAt: new Date() },
    ...
    },
    {
      ...
      clienteId: 'c3',
      cliente: { id: 'c3', nombre: 'Bar El Cruce', cif: 'B87654321', direccion: 'Plaza España 3', telefono: '976123456', email: 'barcruce@mail.es', createdAt: new Date() },
      presupuestoIds: [],
      facturaIds: ['f2', 'f3'],
      estado: 'completado',
